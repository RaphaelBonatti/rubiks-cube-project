...
TEST(ConfigurationTest, Identity) {
  ...
  ASSERT_TRUE(comp_rep.check_combination());
}

TEST(CombinationTest, Identity) {
  char flat_cube[48] = {
      'U', 'U', 'U', 'U', 'U', 'U', 'U', 'U', 'L', 'L', 'L', 'L',
      'L', 'L', 'L', 'L', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F',
      'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'B', 'B', 'B', 'B',
